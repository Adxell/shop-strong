...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    const { register, handleSubmit, control, formState: { errors }, watch, getValues, setValue } = useForm<FormData>({
    ...
    const onDeleteTag = ( Deteletag: string ) => {
        const currentTags = getValues('tags')

        setValue('tags', currentTags.filter( tag => tag !== Deteletag), {shouldValidate: true})
    }
...
export const getServerSideProps: GetServerSideProps = async ({ query }) => {
    ...
    if ( slug === 'new' ) {
        ...
        delete tempPrduct._id;
        tempPrduct.images = ['img1.jpg', 'img2.jpg']
        product  = tempPrduct
    }else {
